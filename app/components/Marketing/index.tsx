...
const MarketData =[
    {
        id: 1,
        title: 'Development',
        description: 'We employ some of the best Craft developers in Europe. We have the expertise to build you a beautiful website that will reflect the quality of your business and help you to achieve your objectives. Where required we can extend it with bespoke functionality,',
        link: ' plugins,',
    ...
    },
    {
        id: 2,
        title: 'Design',
        description: 'The right design can tell your brand’s story and help you to achieve your goals. Whether digital, offline or a combination of the two, well-thought-out',
        link: ' design',
    ...
    },
    {
        id: 3,
        title: 'Marketing',
        description: 'Effective marketing places customers at the heart of your business. We will work alongside you to thoroughly understand both your business and your audience. Our discovery is then used to develop the right multi-channel',
      ...
      <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-9 lg:p-14 p-7">
        {MarketData.map((data) => (
            ...
            <p className="w-full lg:w-[401.33px] text-lg text-gray-500">
              {data.description}
              <Link href='' className="text-[#643EFF] border-b border-[#643EFF]">{data.link}</Link>
              {data.para}
            </p>
