...
const ServiceData = [
  {
    ...
    description: "Experience seamless IT management with our cutting-edge automation solution for OS, SAP Kernel & SAP Hana updates. Say goodbye to manual updates and ensure your systems are always up-to-date with the latest enhancements, security patches, and optimizations, boosting performance and reliability effortlessly.",
  ...
  },
  {
    ...
    description: "Our software ensures the security of your SAP systems and the underlying OS by effortlessly implementing critical hardening measures, safeguarding your data and operations.",
    arrow: <BsArrowRight className="text-black w-6 h-6" />,
    text: "Read more",
  },
  {
    ...
    description: "levate your SAP system management with robust SAP Parameter management and centralized deployments using full-featured Ansible playbooks. Harness the power to streamline changes across your SAP landscape, while enjoying enhanced auditing capabilities that provide transparency and control over system configurations.",
    arrow: <BsArrowRight className="text-black w-6 h-6" />,
    text: "Read more",
  },
  {
  ...
  },
  {
    ...
    description: "Enjoy streamlined SAP automation through seamless integration with Ansible, simplifying complex workflows and enhancing efficiency in your IT operations.",
    arrow: <BsArrowRight className="text-black w-6 h-6" />,
    text: "Read more",
  },
  {
    ...
    description: "Gain immediate insights into your SAP landscape's health and performance with real-time monitoring, empowering you to make informed decisions and prevent potential issues.",
    arrow: <BsArrowRight className="text-black w-6 h-6" />,
    text: "Read more",
  },
  {
    ...
    description: "Safeguard your SAP data and configurations with robust backup management, ensuring quick recovery in case of unexpected data loss or system failures.",
    arrow: <BsArrowRight className="text-black w-6 h-6" />,
    text: "Read more",
  },
  {
    ...
    description: "Gettings started is super simple with our Landscape Discovery Tool. Just point it to an IP range and we'll figure out your system. Have an up-to-date overview of your systems in less than 5 minutes!",
    arrow: <BsArrowRight className="text-black w-6 h-6" />,
    text: "Read more",
  },
  {
    ...
    description: "Access comprehensive and customizable reports to analyze SAP system performance, compliance, and utilization, enabling data-driven decision-making and accountability.",
    arrow: <BsArrowRight className="text-black w-6 h-6" />,
    text: "Read more",
  },
  {
    ...
    description: "Take control of user access to your SAP systems effortlessly, ensuring the right people have the right permissions, enhancing security, and compliance.",
    arrow: <BsArrowRight className="text-black w-6 h-6" />,
    text: "Read more",
  },
];
      ...
      <div className="flex flex-col lg:p-14 p-7">
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 pt-20 gap-8 lg:gap-0">
          {ServiceData.map((data) => (
            <div key={data.id} className="flex gap-4 lg:p-8 p-0 flex-wrap lg:flex-nowrap">
            <div>
              {data.icon}
            </div>
