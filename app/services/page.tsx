...
const ServiceData = [
  {
    id: 1,
    icon: <TbBrandTether className="text-black hover:text-[hsla(36,100%,47%,1)] w-[128px] h-[128px]" />,
  ...
  {
    id: 2,
    icon: <MdOutlineDiamond className="text-black hover:text-[hsla(36,100%,47%,1)] w-[128px] h-[128px]" />,
  ...
  {
    id: 3,
    icon: <VscSettings className="text-black hover:text-[hsla(36,100%,47%,1)] w-[128px] h-[128px]" />,
  ...
  {
    id: 4,
    icon: <BsShieldCheck className="text-black hover:text-[hsla(36,100%,47%,1)] w-[128px] h-[128px]" />,
  ...
  {
    id: 5,
    icon: <PiTarget className="text-black hover:text-[hsla(36,100%,47%,1)] w-[128px] h-[128px]" />,
  ...
  {
    id: 6,
    icon: <FiMap className="text-black hover:text-[hsla(36,100%,47%,1)] w-[128px] h-[128px]" />,
  ...
  {
    id: 8,
    icon: <PiRocketLaunchDuotone className="text-black hover:text-[hsla(36,100%,47%,1)] w-[128px] h-[128px]" />,
  ...
  {
    id: 9,
    icon: <GoGraph className="text-black hover:text-[hsla(36,100%,47%,1)] w-[128px] h-[128px]" />,
  ...
  {
    id: 10,
    icon: <BiSolidUserBadge className="text-black hover:text-[hsla(36,100%,47%,1)] w-[128px] h-[128px]" />,
